    ...
    <div class="presentacion">
        ...
        <div class="producto-info  tm-bg-black-transparent">
            <div class="producto-texto">
                ...
                <p style="display: inline; height: 20px;"><?php echo $peso ?></p><br>
                <br>
                
                <b style="display: inline;">
                    <p style="display: inline;">Modelo:</p>
                </b>
                <p style="display: inline; height: 20px;"><?php echo $modelo ?></p><br>
                <br>
                
                <b style="display: inline;">
                    <p style="display: inline;">Tamaño:</p>
                </b>
                <p style="display: inline; height: 20px;"><?php echo $tamaño ?></p><br>
                <br>
                
                <b style="display: inline;">
                    <p style="display: inline;">Resolucion:</p>
                </b>
                <p style="display: inline; height: 20px;"><?php echo $resolucion ?></p><br>
                <br>
                <b style="display: inline;">
                    <p style="display: inline;">Entradas:</p>
                </b>
                <p style="display: inline; height: 20px;"><?php echo $entradas ?></p><br>
                <br>
